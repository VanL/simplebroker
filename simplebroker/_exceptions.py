...
# Defined in the stdlib-only _constants module, where configuration resolution
# raises InvalidConfigError; import that error from _constants.
from ._constants import BrokerError
