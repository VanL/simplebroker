...
paths, lines, and actual cardinalities. Boundary: only the rule family,
...
Global raw-`noqa` inventory: `BLE001=100`, `C901=53`, `E402=2`, `F401=4`, `PYI034=6`, `PYI036=19`, `SIM115=1`
...
| `[RUFF-SUP-025]` | `examples/reference_reactor.py:915` | 1 | `C901=1` |
| `[RUFF-SUP-026]` | `examples/sqlite_connect.py:314,418` | 2 | `C901=2` |
| `[RUFF-SUP-027]` | `tests/backend_benchmark.py:78`; `tests/test_backend_plugin_resolution.py:344` | 2 | `C901=2` |
| `[RUFF-SUP-028]` | `tests/conftest.py:880` | 1 | `C901=1` |
| `[RUFF-SUP-029]` | `tests/helper_scripts/cross_thread_generator_probe.py:84,109,293,506` | 4 | `C901=4` |
| `[RUFF-SUP-030]` | `tests/test_process_broker_session.py:809,1014` | 2 | `C901=2` |
| `[RUFF-SUP-031]` | `tests/helper_scripts/watcher_sigint_script_improved.py:16`; `tests/test_watcher.py:454` | 2 | `C901=2` |
| `[RUFF-SUP-032]` | `tests/test_watcher_burst_mode.py:494,708` | 2 | `C901=2` |
| `[RUFF-SUP-033]` | `tests/test_watcher_concurrency.py:471,554`; `tests/test_watcher_race_conditions.py:472,745`; `tests/test_watcher_thundering_herd.py:246` | 5 | `C901=5` |
| `[RUFF-SUP-034]` | `tests/test_watcher_multiprocess.py:64,196,313,452,581,712,821` | 7 | `C901=7` |
