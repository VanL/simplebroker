...
| `[RUFF-SUP-003]` | `bin/check-dom15-fixtures::<module>`; `bin/pytest-redis::main`; `simplebroker/_scripts.py::packaging_smoke_main`; `simplebroker/_scripts.py::pytest_pg_main`; `simplebroker/cli.py::_run_cleanup`; `simplebroker/cli.py::_run_vacuum`; `simplebroker/cli.py::main`; `simplebroker/commands.py::_init_broker_target`; `simplebroker/commands.py::_init_sqlite_path`; `simplebroker/commands.py::_move_all_messages`; `simplebroker/commands.py::cmd_status`; `simplebroker/commands.py::cmd_watch` | 12 | `BLE001=12` |
