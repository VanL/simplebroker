...
| 2026-07-30-product-documentation-cutover-plan.md | active — class 5; Phase 1 broadcast promoted and verified at 249df9cb; Phase 2A identity/allocation implementation authorized by completed outside and ordinary reviews; Phase 2B ordered selection/checkpoints gated |
