...
| 2026-07-30-product-documentation-cutover-plan.md | active — class 5; Phase 1 broadcast promoted and verified at 249df9cb; Phase 2A identity/allocation promoted and verified at 090c689e with completed-work and frozen navigation probes passed; Phase 2B ordered selection/checkpoints gated on its readiness amendment |
