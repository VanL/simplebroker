...
| Plan | Status |
|------|--------|
| 2026-08-11-7.1.0-ci-repair-and-publication-plan.md | active — Class 4; repairing exact-SHA cross-platform test defects before coordinated core 7.1.0 and extension 3.6.0 publication |
