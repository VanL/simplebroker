...
| 2026-07-16-code-review-findings-remediation-plan.md | active — implementation present; full gates and completed-work review passed after disposition; uncommitted |
