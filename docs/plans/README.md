...
| Plan | Status |
|------|--------|
| 2026-08-27-all-examples-correctness-and-contract-alignment-plan.md | active - class 4; updates and behaviorally verifies the complete examples inventory for the v8 contract, removes example-owned schema DDL, repairs async ordering/stream loss, reactor late-lower-ID discovery, watcher delivery claims, and shell partial-failure handling, and gates release readiness without changing product specs or publishing a release |
