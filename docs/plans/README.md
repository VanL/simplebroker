...
| Plan | Status |
|------|--------|
| 2026-08-26-release-gate-startup-failure-recovery-plan.md | active - class 3; retain failed v7.5.0 as an unpublished immutable incident tag, release corrective v7.5.1 normally, and make future tagged Trusted Publishing workflows recoverable at their own tag ref without environment widening or publication cancellation |
