...
| Plan | Status |
|------|--------|
| 2026-08-10-7.0.1-ci-repair-and-publication-plan.md | active — class 4; repairs cross-platform 7.0.1 CI regressions, reruns exact-SHA gates, and monitors immutable tag publishing |
