...
| 2026-08-11-activity-waiter-terminal-close-contract-plan.md | active — Class 5; owner activated independently reviewed terminal post-error `ActivityWaiter.close()`, ownership-scoped close/shutdown vocabulary, backend API v6, and coordinated first-party conformance |
