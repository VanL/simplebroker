...
| Plans | Soft-retirement 2026-09-12: 5 plans → `retired-pending`; two completed plans remain harvest-blocked | plan sources `5e4bcb7` (local-only), `5f69748`, `646718f`, `dbace84`, and `3418079` (published) |
| Promotion | (none) | — |
