...
| Plans | 2026-08-13, published last-touch SHAs + local-only pin `d0d2de9` | harvest_candidates=0; retired-pending=21; status-review=1; active=1 | Five-gate harvest soft-retired 21 completed plans. Dump source `d0d2de9` is a disclosed local-only pin. Physical deletion of the 21 `retired-pending` files is a follow-up change. | Next authorized deletion pass after harvest is landed |
| Unindexed | 2026-08-13, published last-touch SHAs + local-only pin `d0d2de9` | 0 | Census remains complete after dump-plan soft-retirement and the IR-1 index row | unindexed &gt; 0 |
