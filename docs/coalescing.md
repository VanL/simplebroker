...
| Plans | Physical retirement 2026-09-14: the 5 plans soft-retired on 2026-09-12 were deleted; 7 newer completed plans remain for harvest review | plan sources `3868d7a`, `5f69748`, `646718f`, `dbace84`, and `3418079` (published) |
| Promotion | (none) | — |
...
|------|------------------------------|-----------------|-----------------|-----------------|
| Lessons | 2026-09-12, published pre-fold source `5f69748` + current-tree text/symbol review | 49 dated ledger entries; 23 are at least 30 days old | Repaired two revised bullets that the required prefix grammar failed to count, then folded 27 cold entries already owned by standing guidance, product/implementation docs, executable examples, or retained plan sources. Kept 23 cold entries: active themes are still accumulating and six live platform/workflow facts still need a topic owner. The `WEXITSTATUS` and unlocked-release-command parity defects found by the sweep were corrected later on 2026-09-12. Chronological watermark stays at 2026-07-28 because the fold was noncontiguous. | Reconsider the causal-proof cluster on 2026-09-24; also reconsider when the remaining platform facts gain a verified topic owner |
| Plans | 2026-09-12, plan sources `3868d7a` (repinned to the identical published plan on 2026-09-14), `5f69748`, `646718f`, `dbace84`, `3418079`, `813dd7ce`, and `f213b12` (local-only) | harvest_candidates=2; retired-pending=5; status-review=1; active=0 | Soft-retired five plans after independent five-gate audits and current-tree reproduction. Kept the shared-config plan completed because its rejection of dropping legacy/namespaced views is durable public-contract negative knowledge that lacks a steady-state alternative record. Kept the message-ID plan completed under the prior recorded block: its rejection of permanent dual SQL layouts still lacks the required promoted rationale or explicit owner judgment. | Promote each blocked alternative under its required planning/owner gate, or obtain an explicit owner judgment that it is plan-local and non-durable; also reconsider when a new completed plan appears |
| Unindexed | 2026-09-12, current-tree census | 0 | All eight plan files remain indexed: five `retired-pending`, two completed/harvest-blocked, and one `status-review`. | unindexed &gt; 0 |
| Promotion | 2026-09-12, published source `5f69748` + current-tree citation review | one mature uncaptured causal-concurrency proof theme; no promotion made | Three-plus independent citations support positive actor-owned state, readiness-split aggregate deadlines, and wall-clock-only liveness valves. Pattern 7 captures only part of that rule; the theme is still accumulating in hot 2026-08-14/25 entries, and durable-guidance promotion requires an owner-ratified Class 3+P plan. | Reconsider on 2026-09-24, or earlier if the owner authorizes the guidance plan |
