...
| Plans | Physical-retirement follow-up 2026-08-23: 11 plans → ledger-only Git archive; soft-retirement commit `34727a52` | ledger source assignments (4 published on `origin/main`; 7 disclosed local-only) |
| Promotion | (none) | — |
...
|------|------------------------------|-----------------|-----------------|-----------------|
| Lessons | 2026-08-23, candidate source pins per Retired Plans ledger + `eef0a1e6` + sweep verification | 69 dated ledger entries; oldest 2026-07-27 (27 days) | Under 30-day age floor / still hot; eight harvest-extracted entries and one sweep-correction entry added, one 2026-08-13 entry revised, no raw lesson folded, watermark unchanged | Oldest candidate reaches the 30-day age floor, or user requests distill |
| Plans | 2026-08-23, soft-retirement `34727a52` + 11 source assignments per Retired Plans ledger | harvest_candidates=0; retired-pending=0; status-review=1; active=0 | Physically deleted 11 plans after current-tree harvest-gate, source retrieval, retained-ref reachability, alternative-record, and surviving-backlink rechecks. Seven source assignments are local-only and four reach `origin/main`; ledger rows are the surviving record. | unindexed &gt; 0 or a new completed plan appears |
| Unindexed | 2026-08-23, soft-retirement `34727a52` + 11 ledger source assignments | 0 | Census remains complete: the sole remaining plan is the indexed status-review runner plan | unindexed &gt; 0 |
| Promotion | 2026-08-23, candidate source pins per Retired Plans ledger | no mature uncaptured workflow theme promoted | Harvest extracted hot dated lessons and repaired existing implementation rationale; no Golden Rule, runbook, skill, gate, or cross-repo rule was promoted. | Distinct uncaptured workflow theme cited ≥3 times or a lesson cluster reaches promotion maturity |
