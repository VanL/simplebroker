...
| Plans | Physical-retirement sweep 2026-08-13: 21 additional plans → ledger-only Git archive (prior 67 remain at `197629e2`) | ledger source SHAs (20 published on `origin/main`; dump plan at local-only `d0d2de9`) |
| Promotion | (none) | — |
...
|------|------------------------------|-----------------|-----------------|-----------------|
| Lessons | 2026-08-13, published last-touch SHAs + local-only pin `d0d2de9` | 58 dated ledger entries; oldest 2026-07-27 (17 days) | Under 30-day age floor / still hot; fourteen harvest-extracted 2026-08-13 entries added, no raw lesson folded, watermark unchanged | Oldest candidate reaches the 30-day age floor, or user requests distill |
| Plans | 2026-08-13, harvest `f73ef5c` + local-only pin `d0d2de9` | harvest_candidates=0; retired-pending=0; status-review=1; active=1 | Physically deleted 21 source-pinned retired-pending plans after retrieval re-check. Ledger rows remain the surviving record. Dump archive pin `d0d2de9` is local-only until published. | unindexed &gt; 0, a new completed plan appears, or dump pin `d0d2de9` is repaired to a published SHA |
| Unindexed | 2026-08-13, harvest `f73ef5c` + local-only pin `d0d2de9` | 0 | Census remains complete: IR-1 plan and status-review runner plan stay indexed | unindexed &gt; 0 |
| Promotion | 2026-08-13, published last-touch SHAs + local-only pin `d0d2de9` | no mature uncaptured workflow theme promoted | Harvest extracted dated lessons only; no Golden Rule, runbook, skill, or gate was promoted. Remaining hot lessons stay in the moment tier. | Distinct uncaptured workflow theme cited ≥3 times or a lesson cluster reaches promotion maturity |
