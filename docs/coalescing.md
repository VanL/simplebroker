...
| Plans | Soft-retirement sweep 2026-08-23: 11 plans → `retired-pending`; physical deletion remains a separate pass | ledger source assignments (4 published on `origin/main`; 7 disclosed local-only) |
| Promotion | (none) | — |
...
| Plans | 2026-08-23, 11 source assignments per Retired Plans ledger | harvest_candidates=0; retired-pending=11; status-review=1; active=0 | Soft-retired 11 source-pinned plans after five-gate review. Seven source assignments are local-only and four reach `origin/main`; physical deletion remains a separate pass. | unindexed &gt; 0, a new completed plan appears, or the 11-plan physical-deletion pass is authorized |
| Unindexed | 2026-08-23, 11 source pins per Retired Plans ledger | 0 | Census remains complete: 11 retired-pending plans and the status-review runner plan stay indexed | unindexed &gt; 0 |
