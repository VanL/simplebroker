...
|------|------------------------------|-----------------|-----------------|-----------------|
| Lessons | 2026-08-06, `94e15bc` + worktree | 29 dated ledger entries; all 0–10 days old | Under 30-day age floor / still hot; no raw lesson folded and watermark unchanged | Oldest candidate reaches age floor, or user requests distill |
| Plans | 2026-08-06, `94e15bc` + worktree | harvest_candidates=10; retired-pending=9; true drafts=0 | Five-gate audit soft-retired 9 plans. Ten remain blocked by missing durable rationale or lessons, unresolved deviation/alternative disposition, a current-owner contradiction, or the plan-context program-theory contract failure. Routine coalescing cannot repair those owners. | Blockers receive separately planned promotion or contract repair, then the next authorized soft-retirement sweep |
| Unindexed | 2026-08-06, `94e15bc` + worktree | 0 | Census remains complete after this nine-plan soft-retirement pass | unindexed &gt; 0 |
| Promotion | 2026-08-06, `94e15bc` + worktree | no mature uncaptured workflow theme promoted | All 29 dated lessons remain in the hot moment tier; candidate plan corrections stay source-local until separately planned promotion | Distinct uncaptured workflow theme cited ≥3 times or lesson cluster reaches promotion maturity |
